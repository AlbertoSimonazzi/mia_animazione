    ...
    components: [
        {
            filename: '1.png',
            name: 'Componente 1',
            explodeDirection: { x: 500, y: 0 },    // Arriva dall'alto
            scale: 1.0,
            rotation: 0,
            zIndex: 2,
            opacity: 1
        ...
        /*{
            filename: '6.png',
            name: 'Componente 6',
            explodeDirection: { x: -400, y: 300 },     // Arriva da destra
            scale: 1.0,
            rotation: 0,
            zIndex: 3,
            opacity: 1
        ...
        /*{
        ...
        },*/
          {
            filename: '5.png',
            name: 'Componente 5',
            explodeDirection: { x: 400, y: 300 },     // Arriva dall'alto
            scale: 1.0,
            rotation: 0,
            zIndex: 4,
            opacity: 1
        ...
        
        {
            filename: '4b.png',
            name: 'Componente 4b',
            explodeDirection: { x: 0, y: -500 },  // Diagonale basso-destra
            scale: 1.0,
            rotation: 0,
            zIndex: 8,
            opacity: 1
